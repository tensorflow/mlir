...
public:
  ...
  virtual bool returnsGenericArray(Operation *op) const { return false; }
  virtual bool requiresShapeInference() const { return false; }
...
public:
  ...
  /// These hooks mirror the hooks for the DialectShapeInferenceInterface, with
  /// default implementations that call the hook on the handler for the dialect
  /// 'op' is registered to.
