...
// No replacement
// CHECK: affine.for %arg0 = 0 to 8 {
// CHECK-NEXT:   affine.dma_start %{{.*}}[%arg0], %{{.*}}[%arg0], %{{.*}}[%c0], %c32 
// CHECK-NEXT:   affine.dma_wait %{{.*}}[%c0], %c32 : memref<1xf32>
// CHECK-NEXT:   "compute"(%{{.*}}) : (memref<32xf32, 1>) -> ()
// CHECK-NEXT:   [[VAL:%[0-9]+]] = affine.load %{{.*}}[%arg0] : memref<32xf32, 1>
