//===- TestLinalgTilePermuteTransforms.cpp - Test Linalg transformation patterns including permutations -----===//
//
...
namespace {
struct TestLinalgTilePermuteTransforms : public FunctionPass<TestLinalgTilePermuteTransforms> {
...
static PassRegistration<TestLinalgTilePermuteTransforms>
    pass("test-linalg-tile-and-permute-patterns",
         "Test Linalg transformation with permutation patterns by applying them greedily.");
